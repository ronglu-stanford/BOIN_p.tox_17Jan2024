rm(list=ls())
setwd("C:/Users/rlu/Downloads/BOIN_simulation_30Dec2023")
...
get.boundary.with.tryCatch <- function(target, my.p.saf, my.p.tox){
  tryCatch(
    expr = {
      return(get.boundary(target, ncohort=10, cohortsize=3, n.earlystop = 12,
...
for(target in c(0.1, 0.15, (20:35)/100, 0.4)){
  ...
  file.name <- paste(paste("earlystop12_target", target*100,"total.n.30.rslt",
